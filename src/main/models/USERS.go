...
type USERS struct {
	...
	Username string  `gorm:"not_null;unique" form:"username" json:"username" binding:"required"`
	...
	Phoneno  string  `gorm:"not_null;unique" form:"phoneno" json:"phoneno" binding:"required"`
